...
3. In a Powershell terminal, `cd` to your project folder `PATH` and run `python bot.py`. This runs the bot and allows you to invoke the `!hiscores` command in Discord.
