...
3. In a Powershell terminal, run `python bot.py`. This runs the bot and allows you to invoke the `!hiscores` command in Discord. If this terminal is closed, the bot won't work.
